...
// import mySvg from '../../assets/expand-collapse.svg';
import mySvg from '../../assets/expand-collapse.svg';
import hhh from '../../assets/hamburger2.svg';

interface Props {
    changePage: (newPage: number) => void;
  }
  
const SideMenu: React.FC<Props> = ({ changePage }) => {
    const [isMenuOpen, setIsMenuOpen] = useState<boolean>(false);
  
    const handleItemClick = (item: number): void => {
      switch (item) {
        case 1:
            changePage(1);
          break;
  ...
  return (
    <div className={`sidebar ${isMenuOpen ? 'open' : 'closed'}`} >
        <nav>
                ...
                <li>
                    <a id="logo-li" href="#">
                        <div className="icon-wrap">
                            {/* <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="logo" onClick={toggleMenu}>
            ...
            <img src={hhh}  alt="SVG Image" width="30" height="30"  onClick={toggleMenu}/>

                        </div>
                        {isMenuOpen && <p id="logo-text">rustinx-react</p>}
                        {/* <p id="logo-text">rustinx-react</p> */}
                        {/* <button className="border-button" onClick={toggleMenu}>
                            <img src={mySvg} alt="Description of SVG" />
                        </button> */}

                    </a>
                </li>
                <span className="sections">Menu</span>
                <li>
                    <a id="item-li" href="#" onClick={() => handleItemClick(1)}>
                        <div className="icon-wrap" >
                        ...
                        {isMenuOpen && <p>Access Event</p>}
                    </a>
                </li>
                <li>
                    <a id="item-li" href="#" onClick={() => handleItemClick(2)}>
                        <div className="icon-wrap" >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480H40c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24V296c0 13.3 10.7 24 24 24s24-10.7 24-24V184c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z"/></svg>

                        </div>
                        {isMenuOpen && <p>Error Event</p>}
                    </a>
                </li>
                <div className="border-div"></div>
                <span className="sections">Tools</span>
                <li>
                    <a id="item-li" href="#">
                        <div className="icon-wrap" >
